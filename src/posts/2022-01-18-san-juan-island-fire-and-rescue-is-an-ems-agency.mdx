...
* Only Fire Districts or Regional Fire Authorities can provide all-hazard emergency services.  Public Hospital Districts, by state law, can only provide EMS and transport services (see [RCW 70.44.060](https://app.leg.wa.gov/rcw/default.aspx?cite=70.44.060)).  Thus, by law, a consolidated agency can only be run under the fire district.
