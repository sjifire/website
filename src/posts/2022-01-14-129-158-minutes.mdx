...
If you want to dive into the data, the stats file—generated every 24 hours—is available [here](https://github.com/sjifire/website/blob/main/src/_data/stats.json).
