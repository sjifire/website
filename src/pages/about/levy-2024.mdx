...
### What’s on my election ballot? <a id="on_ballet" />
...
### Have voters approved a fire levy lid lift in the past? <a id="past_levy" />
...
### Why do fire levies drop? <a id="levy_drop" />
...
### Why is San Juan County Fire District No. 3 asking for this levy lid lift? <a id="why_ask" />
...
### What will you do with the additional revenue? <a id="plan" />
...
### What happens if the fire levy lid lift does not pass? <a id="does_not_pass" />
...
### Where can I find more information? <a id="more_info" />
