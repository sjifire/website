...
sidebar_blocks:
  - _template: image
    src: /assets/media/gallery/easter_bunny_for_firefighters_association_event.jpg
    alt: Easter Bunny at Firefighters Association Event
  - _template: image
    src: /assets/media/gallery/sjifr_full_family.jpg
    alt: Firefighter family at community event
  - _template: image
    src: /assets/media/easter_bunny_2021.png
    alt: Easter Celebration at Jackson Beach
  - _template: image
    src: /assets/media/gallery/starting_young.jpg
    alt: SJIFR teammates
---
