...
sidebar: >
  <div class="sidebar-block">
    ...
    <p>Schedule a station tour, safety presentation, or other educational service.</p>
  ...
  <div class="sidebar-block">
    <h3 class="sidebar__heading">Available Services</h3>
    <ul class="sidebar-list">
      <li>Station tours</li>
      <li>School & community presentations</li>
      <li>Fire extinguisher training</li>
      <li>Home fire safety assessment</li>
      <li>Wildfire property assessment</li>
      <li>Knox Box installation</li>
      <li>Driveway clearance check</li>
    </ul>
  </div>
---
