...
sidebar_blocks:
  - _template: image
    src: /assets/media/dnr_defensible_space_zones.png
    alt: Defensible Space Zones
  - _template: button
    heading: Get Your Free Plan
    description: Sign up for a personalized Wildfire Ready Plan and optional home assessment.
    button_text: Sign Up Now
    button_url: https://wildfireready.dnr.wa.gov/
    new_tab: true
  - _template: richText
    heading: Contact Wildfire Ready
    content: |
      wildfireready@dnr.wa.gov
      877-927-3239
  - _template: richText
    heading: Related Programs
    content: |
      [Firewise USA](/services/firewise/) - Community-wide recognition for neighborhoods.
---
...
<StyledImage src="/assets/media/defensible_space_zones.jpg" alt="Diagram showing the three defensible space zones around a home" align="center" />
...
**Questions?** [Contact us directly](https://forms.office.com/Pages/ResponsePage.aspx?id=j4QiQRfDZ0KcB3xQQVDRvVafkl0BixBCpOYQ4VdsPFZUMlgxSEtST0NYMVVWV0FUMTY3SDVISFUwVi4u). Our team can help you understand the program and get started on your wildfire preparedness journey.
