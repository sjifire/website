...
sidebar: >
  <div class="sidebar-block">
    ...
    <a class="btn btn-primary" href="https://wildfireready.dnr.wa.gov/" target="_blank" rel="noopener">Sign Up at WildfireReady.wa.gov</a>
  </div>

  <div class="sidebar-block">
    <h4 class="sidebar__heading">Contact</h4>
    <p><strong>Email:</strong> <a href="mailto:wildfireready@dnr.wa.gov">wildfireready@dnr.wa.gov</a></p>
    <p><strong>Phone:</strong> <a href="tel:877-927-3239">877-927-3239</a></p>
  </div>

  <div class="sidebar-block">
    <h4 class="sidebar__heading">Related Programs</h4>
    <p><a href="/services/firewise/">Firewise USA</a> - For neighborhoods and HOAs seeking community-wide recognition.</p>
  </div>
---
...
Since 2021, Wildfire Ready Neighbors has engaged 11 counties across Washington and helped over 5,000 residents complete more than 30,000 preparedness actions.

## Why Does This Matter for San Juan County?

The San Juan Islands face a unique challenge as a designated wildland-urban interface, where homes and development intersect with undeveloped, often dry wildlands. This creates conditions where wildfires can quickly threaten structures.

Every year, wildfires occur in the San Juan Islands. While our firefighters and DNR crews have successfully contained these fires, our moderate summer temperatures and vegetation moisture won't always be enough. Climate conditions are changing, and preparation is essential.
