...
sidebar_blocks:
  - _template: button
    ...
    description: Schedule a driveway clearance inspection to ensure emergency vehicles can reach your home.
    ...
    new_tab: true
  - _template: richText
    heading: Fire Marshal
    content: |
      For access requirements and fire code questions:
      [County Fire Marshal](https://www.sanjuancountywa.gov/1088/Fire-Marshal)
  - _template: richText
    heading: Address Assignment
    content: |
      [San Juan County Public Works](https://www.sanjuancountywa.gov/505/Addressing)
---
