...
sidebar_blocks:
  - heading: Get a Burn Permit
    description: 'Coming Soon! Available for purchase October 12, 2026. Check back then.'
  ...
  - heading: Commercial Burns
    description: Require on-site inspection before issuance.
    button_text: Schedule Inspection
    button_url: 'https://www.sanjuanco.com/FormCenter/Fire-Marshal-12/Request-an-Inspection-55'
    new_tab: true
    _template: button
  - heading: Questions?
    content: |
      [San Juan County Fire Marshal](https://www.sanjuanco.com/1088/Fire-Marshal)
      [Contact Us](/contact/)
    _template: richText
---
